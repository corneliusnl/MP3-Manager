/* IMPORTANT NOTE!
 *
 * This file has been modified to work seemlessly with id3tool's configure 
 * scripts.
 *
 * Please Refer to the glibc sources to get an unmodified copy of this file
 *
